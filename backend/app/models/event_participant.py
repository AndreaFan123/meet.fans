...
import enum
from sqlalchemy import Column, Integer, ForeignKey, DateTime, Enum, Text, UniqueConstraint
...
class EventParticipant(Base):
    ...
    # Participation data
    status = Column(Enum(ParticipationStatus),
                    default=ParticipationStatus.REGISTERED, nullable=False)
